    ...
    public class LoadModelFromFilePickerSample : MonoBehaviour
    {
        ...
        private void OnLoad(AssetLoaderContext assetLoaderContext)
        {
            ...
            if (_loadedGameObject != null)
            {
               ...
               var SpawnPosition = Camera.main.transform.forward * 0.3f + Camera.main.transform.position;
                //_loadedGameObject.transform.position = new Vector3(p.x, p.y, p.z + 0.3f);
                _loadedGameObject.transform.position = SpawnPosition;
            }
        }
    }
}
